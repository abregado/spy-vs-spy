...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        // Create TMP_Text in the World
        public static TextMeshPro CreateWorldTMPText(string text, Vector2 rectSize, string name = "TMP_Text", Transform parent = null, Vector3 localPosition = default(Vector3), int fontSize = 40, Color? color = null, 
            TextAlignmentOptions textAlignment = TextAlignmentOptions.Center, int sortingOrder = sortingOrderDefault) {
            if (color == null) color = Color.white;
            return CreateWorldTMPText(parent, text, name, rectSize, localPosition, fontSize, (Color)color, textAlignment, sortingOrder);
        }
        
        // Create Text in the World
        public static TextMeshPro CreateWorldTMPText(Transform parent, string text, string name, Vector2 rectSize, Vector3 localPosition, int fontSize, Color color, 
